...
<VirtualHost *:80 *:4001>
    DocumentRoot "C:/xampp/apps/if-sd-2020-p5-php-healthone-JerRivera/htdocs"
    ServerName healthone.localhost
    <Directory "C:/xampp/apps/if-sd-2020-p5-php-healthone-JerRivera/htdocs">
...
NameVirtualHost *:4001
<VirtualHost *:80 *:4001>
    DocumentRoot "/Applications/XAMPP/xamppfiles/apps/if-sd-2020-p5-php-healthone-JerRivera/htdocs"
    ServerName healthone.localhost
    <Directory "/Applications/XAMPP/xamppfiles/apps/if-sd-2020-p5-php-healthone-JerRivera/htdocs">
        Options Indexes FollowSymLinks ExecCGI Includes
